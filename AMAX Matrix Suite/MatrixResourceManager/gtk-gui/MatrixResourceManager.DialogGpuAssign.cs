...
{
	public partial class DialogGpuAssign
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget MatrixResourceManager.DialogGpuAssign
			this.Name = "MatrixResourceManager.DialogGpuAssign";
			this.Title = global::Mono.Unix.Catalog.GetString ("GPU Assignment");
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child MatrixResourceManager.DialogGpuAssign.VBox
			...
			this.checkbutton2.Label = global::Mono.Unix.Catalog.GetString ("Leave the box blank unless this GPU card will be assigned as EXCLUSIVE");
			this.checkbutton2.DrawIndicator = true;
			this.checkbutton2.UseUnderline = true;
			this.hbox2.Add (this.checkbutton2);
			global::Gtk.Box.BoxChild w2 = ((global::Gtk.Box.BoxChild)(this.hbox2 [this.checkbutton2]));
			w2.Position = 0;
			...
			w5.Position = 0;
			// Internal child MatrixResourceManager.DialogGpuAssign.ActionArea
			...
			this.Show ();
			this.checkbutton2.Clicked += new global::System.EventHandler (this.OnCheckbutton2Clicked);
		}
	}
}
